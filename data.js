...
const DATA = {
  players: [
    ...
    {id:"P020",number:20,name:"Rozalia Bellini",role:"Difesa",avatar:IMG.players.emina,wheelchair:{model:"Da completare",photo:IMG.chairs.defense},wheels:{diameter:'25"',cover:"Raggi grigie (Kenda)",spoke:"Lungo",handrim:"Da completare"},accessories:[],bag:{color:"Grigia",photo:IMG.bags.grey,contents:["2× Ruote"]},notes:""}
    {id:"P021",number:21,name:"Francesco Bettella",role:"Difesa",avatar:IMG.players.emina,wheelchair:{model:"Da completare",photo:IMG.chairs.defense},wheels:{diameter:'25"',cover:"Raggi grigie (Kenda)",spoke:"Lungo",handrim:"Da completare"},accessories:[],bag:{color:"Grigia",photo:IMG.bags.grey,contents:["2× Ruote"]},notes:""}
    {id:"P022",number:22,name:"Amine H.",role:"Difesa",avatar:IMG.players.emina,wheelchair:{model:"Da completare",photo:IMG.chairs.defense},wheels:{diameter:'25"',cover:"Raggi grigie (Kenda)",spoke:"Lungo",handrim:"Da completare"},accessories:[],bag:{color:"Nera",photo:IMG.bags.black,contents:["2× Ruote"]},notes:""}
    {id:"P023",number:23,name:"-",role:"Difesa",avatar:IMG.players.emina,wheelchair:{model:"Da completare",photo:IMG.chairs.defense},wheels:{diameter:'25"',cover:"Raggi grigie (Kenda)",spoke:"Lungo",handrim:"Da completare"},accessories:[],bag:{color:"Nera",photo:IMG.bags.black,contents:["2× Ruote"]},notes:""}
  ],
  containers:[
